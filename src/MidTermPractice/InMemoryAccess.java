 ...
 * @author knyghtspup
 */
public class InMemoryAccess implements ReceiptFormatStrategy {
...
//    };
    ...
    private Product[] products = {
        ...
        new Product("C222", "Women's Socks    ", 9.50, new ZeroDiscount())
    };
     ...
     */
    @Override
    public final Customer findCustomerInfo(final String custId) {
     ...
     */
    @Override
    public final Product findProductInfo(final String prodId) {
        // validation is needed for method parameter
